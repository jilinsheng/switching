...
import com.md.model.BizJtdyzjbhxxPK;
...
public class BizJtdyzjbhxxJpaController implements Serializable {
    ...
    public void create(BizJtdyzjbhxx bizJtdyzjbhxx) throws PreexistingEntityException, Exception {
        if (bizJtdyzjbhxx.getBizJtdyzjbhxxPK() == null) {
            bizJtdyzjbhxx.setBizJtdyzjbhxxPK(new BizJtdyzjbhxxPK());
        }
        ...
        try {
            ...
            if (findBizJtdyzjbhxx(bizJtdyzjbhxx.getBizJtdyzjbhxxPK()) != null) {
    ...
    public void edit(BizJtdyzjbhxx bizJtdyzjbhxx) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                BizJtdyzjbhxxPK id = bizJtdyzjbhxx.getBizJtdyzjbhxxPK();
    ...
    public void destroy(BizJtdyzjbhxxPK id) throws NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            ...
            try {
                ...
                bizJtdyzjbhxx.getBizJtdyzjbhxxPK();
    ...
    public BizJtdyzjbhxx findBizJtdyzjbhxx(BizJtdyzjbhxxPK id) {
        EntityManager em = getEntityManager();
        try {
