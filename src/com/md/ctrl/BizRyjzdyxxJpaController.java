...
import com.md.model.BizRyjzdyxxPK;
...
public class BizRyjzdyxxJpaController implements Serializable {
    ...
    public void create(BizRyjzdyxx bizRyjzdyxx) throws PreexistingEntityException, Exception {
        if (bizRyjzdyxx.getBizRyjzdyxxPK() == null) {
            bizRyjzdyxx.setBizRyjzdyxxPK(new BizRyjzdyxxPK());
        }
        ...
        try {
            ...
            if (findBizRyjzdyxx(bizRyjzdyxx.getBizRyjzdyxxPK()) != null) {
    ...
    public void edit(BizRyjzdyxx bizRyjzdyxx) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                BizRyjzdyxxPK id = bizRyjzdyxx.getBizRyjzdyxxPK();
    ...
    public void destroy(BizRyjzdyxxPK id) throws NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public BizRyjzdyxx findBizRyjzdyxx(BizRyjzdyxxPK id) {
        EntityManager em = getEntityManager();
        try {
